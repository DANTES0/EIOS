  ...
  <div class="content-wrap">
    ...
    <div class="content-photo">
      ...
      <div class="upload-section">
        <input type="file" id="file-upload" @change="handleFileChange" class="file-input" />
        <label for="file-upload" class="file-label">Выбрать фото</label>
        <input type="text" :value="selectedFileName" readonly class="file-name" placeholder="Файл не выбран" />
      </div>
    </div>
