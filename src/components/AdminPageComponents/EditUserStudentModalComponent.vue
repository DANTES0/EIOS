...
<template>
  <div v-if="authState.isVisibleEditStudentModelComponent" class="modal-add-user-wrapper" @click="hideModal">
    <div class="modal-add-user-container">
      <div class="modal-add-user-block">
        <div class="modal-add-user-title" style="font-size: 28px;">Редактирование аккаунта студента</div>
        <div class="input-name wrap" style="margin-top: 40px;">
          <div class="input-name-title title">Введите Имя</div>
          <input v-model="name" placeholder="Логин...." type="text" class="input--name-text input" :class="{'error': loginError}">
        </div>
