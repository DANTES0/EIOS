...
<template>
      ...
      <div class="headerAdd">
        <div class="headerAddEdit">
          <div class="headerArticle">
            ...
            <textarea v-model="headLine" type="text" class="inputArticle input"></textarea>
          </div>
          <div class="headerMainDesc">
            <div class="title-header">Основная мысль новости</div>
            <textarea v-model="mainInfo" type="text" class="inputMainDesc input"></textarea>
          </div>
        </div>
        <div class="category-date">
          <div class="category">
            ...
            <div class="select">
              <VueSelect v-model="selected" :placeholder="placeholder" :options="array" @option-selected="handleOptionSelected"></VueSelect>
            </div>
          </div>
          <div class="date">
        ...
        <div id="preview">
          <div v-for="(image, index) in images" :key="index" class="primg">
            ...
            <div class="radiobutton">
              <input type="radio" :value="index" v-model="mainImageIndex" class="radio" />
  ...
  :deep(input[type="checkbox"]::after) {
    transform: translateY(-8px) translateX(0.5px) scale(1.0);
  }
