    ...
    <div class="shedule-wrap">
        <table>
            ...
            <tbody>
                <tr>
                    <th scope="row">
                        <div class="time-schedule">9:00 10:30</div>
                        <div class="type-week">Нечет</div>
                    </th>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ firstRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ firstRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ firstRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ firstRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ firstRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ firstRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ firstRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ firstRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ firstRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ firstRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ firstRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ firstRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SecondRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SecondRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SecondRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SecondRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SecondRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SecondRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SecondRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SecondRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SecondRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SecondRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SecondRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SecondRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <div class="time-schedule">10:50 12:20</div>
                        <div class="type-week">Нечет</div>
                    </th>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirdRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirdRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirdRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirdRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirdRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirdRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirdRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirdRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirdRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirdRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirdRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirdRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FourthRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FourthRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FourthRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FourthRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FourthRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FourthRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FourthRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FourthRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FourthRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FourthRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FourthRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FourthRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <div class="time-schedule">12:40 14:10</div>
                        <div class="type-week">Нечет</div>
                    </th>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FifthRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FifthRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FifthRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FifthRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FifthRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FifthRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FifthRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FifthRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FifthRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FifthRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ FifthRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ FifthRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SixthRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SixthRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SixthRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SixthRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SixthRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SixthRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SixthRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SixthRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SixthRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SixthRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SixthRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SixthRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <div class="time-schedule">14:55 16:25</div>
                        <div class="type-week">Нечет</div>
                    </th>
                    <td>
                        <div class="title-item">
                            {{ SeventhRowNechet[0].subjectName }}
                        </div>
                        <div class="type-item">{{ SeventhRowNechet[0].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SeventhRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SeventhRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ SeventhRowNechet[1].subjectName }}
                        </div>
                        <div class="type-item">{{ SeventhRowNechet[1].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SeventhRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SeventhRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ SeventhRowNechet[2].subjectName }}
                        </div>
                        <div class="type-item">{{ SeventhRowNechet[2].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SeventhRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SeventhRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ SeventhRowNechet[3].subjectName }}
                        </div>
                        <div class="type-item">{{ SeventhRowNechet[3].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SeventhRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SeventhRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ SeventhRowNechet[4].subjectName }}
                        </div>
                        <div class="type-item">{{ SeventhRowNechet[4].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SeventhRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SeventhRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ SeventhRowNechet[5].subjectName }}
                        </div>
                        <div class="type-item">{{ SeventhRowNechet[5].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ SeventhRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ SeventhRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EighthRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EighthRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EighthRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EighthRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EighthRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EighthRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EighthRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EighthRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EighthRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EighthRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EighthRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EighthRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <div class="time-schedule">16:45 18:15</div>
                        <div class="type-week">Нечет</div>
                    </th>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ NinethRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ NinethRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ NinethRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ NinethRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ NinethRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ NinethRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ NinethRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ NinethRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ NinethRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ NinethRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ NinethRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ NinethRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TenthRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TenthRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TenthRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TenthRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TenthRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TenthRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TenthRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TenthRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TenthRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TenthRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TenthRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TenthRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <div class="time-schedule">18:30 20:00</div>
                        <div class="type-week">Нечет</div>
                    </th>
                    <td>
                        <div class="title-item">
                            {{ EleventhRowNechet[0].subjectName }}
                        </div>
                        <div class="type-item">{{ EleventhRowNechet[0].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EleventhRowNechet[0].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EleventhRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ EleventhRowNechet[1].subjectName }}
                        </div>
                        <div class="type-item">{{ EleventhRowNechet[1].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EleventhRowNechet[1].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EleventhRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ EleventhRowNechet[2].subjectName }}
                        </div>
                        <div class="type-item">{{ EleventhRowNechet[2].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EleventhRowNechet[2].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EleventhRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ EleventhRowNechet[3].subjectName }}
                        </div>
                        <div class="type-item">{{ EleventhRowNechet[3].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EleventhRowNechet[3].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EleventhRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ EleventhRowNechet[4].subjectName }}
                        </div>
                        <div class="type-item">{{ EleventhRowNechet[4].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EleventhRowNechet[4].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EleventhRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ EleventhRowNechet[5].subjectName }}
                        </div>
                        <div class="type-item">{{ EleventhRowNechet[5].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ EleventhRowNechet[5].teacherName }}
                            </div>
                            <div class="auditoriya-item">
                                {{ EleventhRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="title-item">
                            {{ TwelethRowNechet[0].subjectName }}
                        </div>
                        <div class="type-item">{{ TwelethRowNechet[0].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TwelethRowNechet[0].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TwelethRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ TwelethRowNechet[1].subjectName }}
                        </div>
                        <div class="type-item">{{ TwelethRowNechet[1].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TwelethRowNechet[1].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TwelethRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ TwelethRowNechet[2].subjectName }}
                        </div>
                        <div class="type-item">{{ TwelethRowNechet[2].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TwelethRowNechet[2].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TwelethRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ TwelethRowNechet[3].subjectName }}
                        </div>
                        <div class="type-item">{{ TwelethRowNechet[3].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TwelethRowNechet[3].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TwelethRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ TwelethRowNechet[4].subjectName }}
                        </div>
                        <div class="type-item">{{ TwelethRowNechet[4].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TwelethRowNechet[4].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TwelethRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ TwelethRowNechet[5].subjectName }}
                        </div>
                        <div class="type-item">{{ TwelethRowNechet[5].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ TwelethRowNechet[5].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ TwelethRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <div class="time-schedule">20:05 21:35</div>
                        <div class="type-week">Нечет</div>
                    </th>
                    <td>
                        <div class="title-item">
                            {{ ThirteenRowNechet[0].subjectName }}
                        </div>
                        <div class="type-item">{{ ThirteenRowNechet[0].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirteenRowNechet[0].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirteenRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThirteenRowNechet[1].subjectName }}
                        </div>
                        <div class="type-item">{{ ThirteenRowNechet[1].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirteenRowNechet[1].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirteenRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThirteenRowNechet[2].subjectName }}
                        </div>
                        <div class="type-item">{{ ThirteenRowNechet[2].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirteenRowNechet[2].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirteenRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThirteenRowNechet[3].subjectName }}
                        </div>
                        <div class="type-item">{{ ThirteenRowNechet[3].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirteenRowNechet[3].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirteenRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThirteenRowNechet[4].subjectName }}
                        </div>
                        <div class="type-item">{{ ThirteenRowNechet[4].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirteenRowNechet[4].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirteenRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThirteenRowNechet[5].subjectName }}
                        </div>
                        <div class="type-item">{{ ThirteenRowNechet[5].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThirteenRowNechet[5].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThirteenRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="title-item">
                            {{ ThortheenRowNechet[0].subjectName }}
                        </div>
                        <div class="type-item">{{ ThortheenRowNechet[0].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThortheenRowNechet[0].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThortheenRowNechet[0].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThortheenRowNechet[1].subjectName }}
                        </div>
                        <div class="type-item">{{ ThortheenRowNechet[1].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThortheenRowNechet[1].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThortheenRowNechet[1].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThortheenRowNechet[2].subjectName }}
                        </div>
                        <div class="type-item">{{ ThortheenRowNechet[2].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThortheenRowNechet[2].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThortheenRowNechet[2].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThortheenRowNechet[3].subjectName }}
                        </div>
                        <div class="type-item">{{ ThortheenRowNechet[3].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThortheenRowNechet[3].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThortheenRowNechet[3].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThortheenRowNechet[4].subjectName }}
                        </div>
                        <div class="type-item">{{ ThortheenRowNechet[4].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThortheenRowNechet[4].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThortheenRowNechet[4].classroom }}
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="title-item">
                            {{ ThortheenRowNechet[5].subjectName }}
                        </div>
                        <div class="type-item">{{ ThortheenRowNechet[5].type }}</div>
                        <div class="prepodavatel-auditoriya">
                            <div class="prepodavatel-item">
                                {{ ThortheenRowNechet[5].teacherId }}
                            </div>
                            <div class="auditoriya-item">
                                {{ ThortheenRowNechet[5].classroom }}
                            </div>
                        </div>
                    </td>
                </tr>
