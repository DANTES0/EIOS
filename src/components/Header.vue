        ...
        <div class="header-wrapper">
            <div class="header-wrapper-container">
                ...
                <div class="page-header">
                    <a class="page" id="main" data-title="Главная страница" @click="$router.push('/')"></a>
                    <a class="page" id = "q" data-title="Новости" @click="$router.push('/news')"></a>
                    <a class="page" id = "w" data-title = "Расписание"@click="$router.push('/entrants')"></a>
                    <a class="page" id = "e" data-title = "Комиссия"@click="$router.push('/gallery')"></a>
...
@font-face {
    ...
    .page:hover::after {
        ...
        left: 50px; top: 5%; /* Положение подсказки */
    ...
    #r {
        ...
        margin-top: 15px;
        transform: scale(2.5);
        filter: invert(63%) sepia(92%) saturate(7299%) hue-rotate(215deg) brightness(99%) contrast(94%);
        /* filter: invert(54%) sepia(1%) saturate(0%) hue-rotate(341deg) brightness(93%) contrast(89%); */
    }
    #r:hover {
